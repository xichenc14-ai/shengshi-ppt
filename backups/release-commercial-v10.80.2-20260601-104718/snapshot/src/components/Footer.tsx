        ...
        <div className="mt-10 pt-8 border-t border-gray-100">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-400">
              <Link href="/privacy" className="hover:text-purple-600 transition-colors">隐私政策</Link>
              <span className="w-1 h-1 rounded-full bg-gray-300" />
              <Link href="/terms" className="hover:text-purple-600 transition-colors">用户协议</Link>
              <span className="w-1 h-1 rounded-full bg-gray-300" />
              <Link href="/service-terms" className="hover:text-purple-600 transition-colors">服务条款</Link>
            </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-[11px] text-gray-300">© 2026 省心PPT · AI演示生成平台 · {APP_VERSION} · 版权所有</p>
          </div>
        </div>
      </div>
    </footer>
