          ...
          <div className="mb-4 sm:mb-5">
            ...
            <div className="mb-2.5 sm:mb-3 rounded-xl border border-indigo-100 bg-indigo-50/60 p-2 sm:p-3">
              ...
              <div className="rounded-lg bg-white border border-indigo-100 p-2">
                ...
                <div className="relative h-16 sm:h-24 rounded-lg border border-slate-200 p-2 sm:p-3 overflow-hidden" style={{ backgroundColor: bgColor }}>
                  ...
                  <div className="absolute left-2 bottom-2 sm:left-3 sm:bottom-3">
                    <p className="text-sm sm:text-xl font-black leading-none" style={{ color: fontColor }}>省心PPT</p>
            ...
            <div className="grid grid-cols-4 sm:grid-cols-3 gap-1 sm:gap-2">
              {COLOR_THEMES.map(t => (
                <button
                  ...
                  className={`flex items-center gap-1 px-1 py-1.5 sm:gap-1.5 sm:px-3 sm:py-2.5 rounded-lg sm:rounded-xl border-2 transition-all ${
                    currentThemeId === t.id
                ...
                >
                  ...
                  <span className={`text-[9px] sm:text-xs font-medium truncate ${currentThemeId === t.id ? 'text-[#4338CA]' : 'text-gray-600'}`}>{t.name}</span>
                  {currentThemeId === t.id && (
