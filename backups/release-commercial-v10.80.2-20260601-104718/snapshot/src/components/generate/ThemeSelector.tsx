        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 gap-1.5 sm:gap-2">
          {THEME_COLORS.map((color) => (
            <button
              ...
              className="flex items-center gap-1.5 p-2 sm:gap-2 sm:p-3 rounded-lg sm:rounded-xl border-2 transition-all hover:border-purple-200"
              style={{
            ...
            >
              ...
              <span className="text-[11px] sm:text-xs font-medium text-gray-700 truncate">{color.name}</span>
            </button>
          ))}
        </div>
        
        {/* 展开的详细主题 */}
        <div className="mt-2.5 sm:mt-3 p-2.5 sm:p-4 bg-gray-50 rounded-xl border border-gray-100 animate-fade-in">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-1.5 sm:gap-2">
              {activeThemes.map((theme) => (
                <button
                  ...
                  className="px-2 py-1.5 sm:px-3 bg-white border border-gray-200 rounded-lg text-[11px] sm:text-xs text-gray-600 hover:border-purple-300 hover:text-purple-600 transition-all capitalize truncate"
                  style={{
