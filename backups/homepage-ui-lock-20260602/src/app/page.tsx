...
export default function Home() {
  ...
  const loadInlinePreview = useCallback(async () => {
    ...
    try {
      ...
      setPreviewPdfUrl(`${blobUrl}#toolbar=0&view=FitH`);
    } catch (e: any) {
            ...
            {phase === 'input' && (
              <>
                <section className="relative">
                  ...
                  <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-4 lg:gap-10 items-center mb-1 md:mb-0">
                    <div className="sx-appear pt-0 md:pt-8 lg:pt-3 text-center lg:text-left">
                      <h1 className="text-[30px] md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.04] sx-gradient-text">
                        创建你的 PPT
                      </h1>
                      ...
                      <p className="mt-2.5 md:mt-4 max-w-xl mx-auto lg:mx-0 text-[13px] md:text-base text-slate-500 leading-relaxed">
                        输入主题，AI 自动完成大纲、版式、配色和配图，让每一次表达都有专业设计感。
                      </p>
                      <div className="mt-3 md:hidden mx-auto max-w-[300px] rounded-2xl border border-indigo-100/80 bg-white/75 px-3 py-2">
                        <div className="flex items-center justify-between gap-2">
                          <span className="inline-flex w-7 h-7 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 text-white text-[11px] font-bold items-center justify-center">1</span>
                          <span className="h-2.5 flex-1 rounded-full bg-indigo-100/80" />
                          <span className="inline-flex w-7 h-7 rounded-full bg-gradient-to-br from-sky-500 to-indigo-500 text-white text-[11px] font-bold items-center justify-center">2</span>
                          <span className="h-2.5 flex-1 rounded-full bg-sky-100/80" />
                          <span className="inline-flex w-7 h-7 rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 text-white text-[11px] font-bold items-center justify-center">3</span>
                        </div>
                        <p className="mt-1.5 text-[11px] text-indigo-600 font-semibold text-center">智能梳理 · 自动大纲 · 一键渲染</p>
                      </div>
                      <div className="mt-5 hidden md:flex flex-wrap justify-center lg:justify-start gap-3">
                        {[
                      ...
                      <div className="mt-6 hidden md:grid grid-cols-4 gap-3 max-w-lg mx-auto lg:mx-0">
                        {[
                          ['30秒', '平均生成时间'],
                          ['50+', '精选主题'],
                          ['4种', '配图模式'],
                    ...
                    <div className="sx-product-stage sx-appear sx-appear-delay-1 hidden md:block">
                      <div className="sx-process-board">
                        <div className="sx-process-dotline" />
                        {[
                          ['1', '智能梳理需求', '识别主题与表达目标'],
                          ['2', '自动大纲生成', '结构与逻辑自动组织'],
                          ['3', '智能匹配配图', '风格统一、内容贴合'],
                          ...
                          <div
                            key={title}
                            className="sx-process-node"
                            style={{ animationDelay: `${idx * 0.55}s` }}
                          >
                            <span className="sx-process-index">{step}</span>
                            <div className="min-w-0">
                              <p className="sx-process-title">{title}</p>
                              <p className="sx-process-desc">{desc}</p>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          <div className="max-w-[1400px] mx-auto px-3 md:px-6 pt-6 md:pt-8 pb-16">
            ...
            <div className="sx-glass-strong rounded-[28px] shadow-xl border border-indigo-100/70 overflow-hidden mb-6">
              ...
              <div className="p-3 md:p-5">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-indigo-100 bg-[#0f1020] min-h-[62vh] md:min-h-[78vh]">
                  {previewLoading ? (
                    ...
                    <object
                      ...
                      className="w-full h-[62vh] md:h-[78vh] bg-white"
                    >
                      <iframe
                        src={previewPdfUrl}
                        className="w-full h-[62vh] md:h-[78vh] bg-white"
