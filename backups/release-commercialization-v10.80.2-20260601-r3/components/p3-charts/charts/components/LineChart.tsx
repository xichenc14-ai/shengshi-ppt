...
type LineTooltipEntry = { name?: string; value?: unknown; color?: string };
type LineTooltipProps = { active?: boolean; payload?: LineTooltipEntry[]; label?: string };

const LineTooltipContent: React.FC<LineTooltipProps> = ({ active, payload, label }) => {
    ...
    <div style={{ width, height: height + (title ? 30 : 0) }}>
      ...
      <ResponsiveContainer width="100%" height={height}>
        <RechartsLineChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          ...
          {showTooltip && <Tooltip content={<LineTooltipContent />} {...buildTooltipConfig()} />}
          {showLegend && (
