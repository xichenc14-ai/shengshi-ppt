...
export default function ProPanel({ open, onClose, genMode, setGenMode, theme, setTheme, tone, setTone, imgMode, setImgMode, pages, setPages }: ProPanelProps) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 h-[86vh] rounded-t-2xl md:rounded-none md:inset-x-auto md:right-0 md:top-0 md:bottom-0 md:h-auto w-full md:w-80 lg:w-96 bg-white shadow-2xl z-50 overflow-y-auto animate-slide-in-right">
        {/* Header */}
