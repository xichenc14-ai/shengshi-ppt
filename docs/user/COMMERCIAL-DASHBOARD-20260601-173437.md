...
- Generated: 2026-06-01T09:34:37.150Z
...
Doctor archive: docs/user/COMMERCIAL-ENV-DOCTOR-20260601-173436.md
```
- go-live:commercial:
```text
ironment Readiness ===
FAIL  Core variables - missing: PAYMENT_NOTIFY_URL, PAYMENT_NOTIFY_SECRET, ALLOWED_CALLBACK_IPS
FAIL  PAYMENT_NOTIFY_URL is https - value: (empty)
FAIL  PAYMENT_NOTIFY_SECRET strength - length: 0
FAIL  ALLOWED_CALLBACK_IPS format - value: (empty)
PASS  WeChat template URL is https
PASS  Alipay template URL is https
...
[release-gate] archive: docs/user/COMMERCIAL-RELEASE-GATE-20260601-173436.md
...
Objective audit archive: docs/user/COMMERCIAL-OBJECTIVE-AUDIT-20260601-173437.md
