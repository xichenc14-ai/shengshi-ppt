...
- Verdict: **NOT_READY**
- Required checks passed: 12/13
- Timestamp: 2026-06-01T09:31:14.783Z
...
- [x] 支付接口限流能力（订阅/单次）
  evidence: src/app/api/payment/route.ts + src/app/api/pay-once/route.ts include rate-limit keys
- [x] 支付回调与轮询限流能力
  evidence: payment callback/polling rate-limit keys exist
- [x] 关键支付闭环测试通过
...
[release-gate] archive: docs/user/COMMERCIAL-RELEASE-GATE-20260601-173114.md
